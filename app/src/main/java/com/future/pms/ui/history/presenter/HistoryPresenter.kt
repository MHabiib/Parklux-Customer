package com.future.pms.ui.history.presenter

import com.future.pms.ui.base.BasePresenter
import com.future.pms.ui.history.network.HistoryApi
import com.future.pms.ui.history.view.HistoryContract
...
class HistoryPresenter @Inject constructor() : BasePresenter<HistoryContract>() {
  ...
  fun loadCustomerBooking(accessToken: String, page: Int) {
    subscriptions.add(historyApi.getCustomerBooking(accessToken, page).subscribeOn(
